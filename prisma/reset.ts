...
async function main() {
    ...
    await prisma.service.createMany({
        data: [
            ...
            { establishmentId: clinic.id, name: 'Vacunación Completa', price: 60, duration: 15, category: 'vaccination', description: 'Incluye vacuna y registro en carnet' },
            { establishmentId: clinic.id, name: 'Desparasitación Interna', price: 40, duration: 15, category: 'deworming', description: 'Interna y externa' },
            { establishmentId: clinic.id, name: 'Examen de Sangre', price: 120, duration: 20, category: 'test', description: 'Hemograma completo' },
            { establishmentId: clinic.id, name: 'Esterilización Especializada', price: 280, duration: 120, category: 'surgery', description: 'Incluye anestesia y seguimiento post-operatorio' },
            ...
            { establishmentId: groomerShop.id, name: 'Paseo Grupal Dinámico', price: 25, duration: 90, category: 'walk', description: '90 minutos de recreación con paseador profesional' },
            { establishmentId: groomerShop.id, name: 'Hospedaje Pet Daycare (Día)', price: 90, duration: 480, category: 'general', description: 'Cuidado premium diurno con juegos' },
        ]
    })
