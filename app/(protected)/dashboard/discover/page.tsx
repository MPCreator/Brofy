        ...
        <div className="space-y-6 pb-20 lg:pb-0">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500">Compara y agenda servicios veterinarios cercanos</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 bg-white p-3 rounded-2xl border border-slate-200/60 shadow-sm">
                <div className="relative flex items-center col-span-1 md:col-span-2">
                    ...
                    <input 
                        ...
                        className="w-full pl-9 pr-3 py-2 bg-slate-50 hover:bg-slate-100/75 focus:bg-white border border-transparent focus:border-primary-400 rounded-xl text-xs focus:outline-none transition-all font-medium text-slate-800"
                    />
                </div>
                ...
                <div className="relative flex items-center">
                    <input 
                        ...
                        className="w-full pl-3 pr-10 py-2 bg-slate-50 hover:bg-slate-100/75 focus:bg-white border border-transparent focus:border-primary-400 rounded-xl text-xs focus:outline-none transition-all font-bold text-slate-700 cursor-pointer"
                    />
                </div>
            </div>
            ...
            {/* Airbnb-style Grid for Logged In User Dashboard */}
            {loading ? (
