            ...
            <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                {activeTab === 'historial' && (
                    <div className="space-y-4">
                        <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 text-xs text-slate-650 leading-relaxed shadow-sm">
                            📋 <strong>Historial Completo:</strong> Esta es la cronología completa de todas las consultas, servicios y atenciones de tu mascota ordenadas desde la más reciente.
                        </div>
                                                ...
                                                <div className="flex-1 bg-white rounded-2xl border border-slate-100 p-4 hover:shadow-sm transition-all">
                                                    ...
                                                    {entry.provider && (
                                                        <p className="text-xs text-slate-500 mt-1 font-medium">
                                                            Atendido por: <span className="text-slate-705 font-bold">Dr. {entry.provider}</span>
                                                        </p>
                                                    )}

                                                    {entry.fromRecord && entry.recordData && (
                                                        <div className="mt-3 pt-3 border-t border-slate-100 grid grid-cols-2 gap-2 text-xs text-slate-650 bg-slate-50/50 p-2.5 rounded-xl">
                                                    ...
                                                    {entry.notes && (
                                                        <div className="mt-2.5 p-2 bg-slate-50 rounded-lg text-xs text-slate-600 border border-slate-100">
                                                            <span className="font-bold text-slate-750 block">Indicaciones:</span>
                ...
                {activeTab === 'diagnosticos' && (
                    <div className="space-y-4">
                        <div className="bg-emerald-50 border border-emerald-250 rounded-2xl p-4 text-xs text-slate-750 leading-relaxed shadow-sm">
                            💡 <strong>¿Cómo se llena esta categoría?</strong> Aquí se agrupan los diagnósticos médicos oficiales, cirugías o resultados de exámenes que el veterinario detalla en la ficha médica de atención de tu mascota.
                        </div>
                ...
                {activeTab === 'tratamientos' && (
                    <div className="space-y-4">
                        <div className="bg-violet-50 border border-violet-200 rounded-2xl p-4 text-xs text-slate-750 leading-relaxed shadow-sm">
                            💡 <strong>¿Cómo se llena esta categoría?</strong> Aquí se recopilan las recetas médicas (prescripciones), indicaciones de tratamiento o dosis de medicamentos indicados por el especialista en la atención, así como las próximas visitas de control sugeridas.
                        </div>
                                    ...
                                    <div key={idx} className="bg-white rounded-2xl border border-slate-100 p-5 shadow-sm space-y-3">
                                        ...
                                        {entry.recordData?.prescription && (
                                            <div className="p-3 bg-slate-50 border border-slate-100 rounded-xl space-y-1.5">
                                                ...
                                                <p className="text-xs text-slate-660 whitespace-pre-line leading-relaxed">{entry.recordData.prescription}</p>
                                            </div>
                                        )}
                                        ...
                                        {entry.recordData?.treatment && (
                                            <div className="p-3 bg-slate-50 border border-slate-100 rounded-xl space-y-1.5">
                                                ...
                                                <p className="text-xs text-slate-660 whitespace-pre-line leading-relaxed">{entry.recordData.treatment}</p>
                                            </div>
                                        )}
