                ...
                <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100 space-y-8">
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="space-y-2 text-sm text-slate-700 leading-relaxed">
                            ...
                            <p><strong>"Servicio Digital":</strong> El conjunto de funcionalidades que Brofy provee: directorio, reserva de agenda, sistema OTP de verificación de identidad, gestión de historial médico digital, y procesamiento de pagos por el uso de infraestructura.</p>
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="space-y-3 text-sm text-slate-700 leading-relaxed">
                            <p>
                                Brofy actúa exclusivamente como intermediario tecnológico entre Usuarios y Profesionales. La Plataforma facilita la búsqueda de Profesionales, la gestión de agendas, la verificación de identidad mediante código OTP y el almacenamiento de información clínica en formato digital.
                            </p>
                            <p>
                    ...
                    {/* 4 */}
                    <section className="space-y-3">
                        <h2 className="text-lg font-bold text-slate-900">4. Sistema OTP de Verificación de Identidad</h2>
                        <div className="space-y-2 text-sm text-slate-700 leading-relaxed">
                            <p>
                                La Plataforma implementa un sistema de Contraseña de Un Solo Uso (OTP, por sus siglas en inglés) con el propósito de verificar la identidad del Usuario en el momento de la atención, garantizando la correcta asignación del historial médico digital y previniendo la desintermediación entre Usuarios y Profesionales fuera de la Plataforma.
                            </p>
                            <p>
                                El código OTP es generado automáticamente tras la confirmación de la agenda y el abono del Cargo por Infraestructura. Dicho código es único, intransferible y de uso personal. El Usuario deberá presentar su código OTP al Profesional al momento de la atención; el Profesional lo ingresará en la Plataforma para desbloquear el historial médico digital.
                            </p>
                            <p>
                                El código OTP permanece válido desde su emisión hasta que el Profesional lo utiliza para iniciar la atención. No existe límite de tiempo artificial que obligue al Usuario a concurrir en un plazo determinado.
                            </p>
                        </div>
                    </section>
                        ...
                        <div className="space-y-3 text-sm text-slate-700 leading-relaxed">
                            <div className="bg-primary-50 border border-primary-200 rounded-xl px-4 py-3 space-y-2">
                                ...
                                <ul className="list-disc list-inside space-y-1 pl-2">
                                    ...
                                    <li>La generación y gestión del sistema OTP de verificación de identidad.</li>
                    ...
                    <section className="space-y-3">
                        ...
                        <div className="space-y-2 text-sm text-slate-700 leading-relaxed">
                            <p>
                                El Cargo por Uso de Infraestructura Digital definido en la Cláusula 5 se entiende <strong>íntegramente devengado y percibido</strong> por Brofy en el momento en que los servicios digitales son efectivamente prestados al Usuario, lo que ocurre al generarse el código OTP y confirmarse la agenda en la Plataforma.
                            </p>
                            <p>
